<?php
namespace Yanjiadong\Weather\Tests;

use PHPUnit\Framework\TestCase;
use Yanjiadong\Weather\Exceptions\InvalidArgumentException;
use Yanjiadong\Weather\Exceptions\HttpException;
use Yanjiadong\Weather\Weather;
